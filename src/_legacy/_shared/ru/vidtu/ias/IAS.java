...
public final class IAS {
     ...
     */
    @NotNull
    public static final String USER_AGENT = "deobso/%s (https://github.com/s0uryyy/deobso)".formatted(IAS.class.getPackage().getImplementationVersion());
        ...
        task.set(executor.scheduleWithFixedDelay(() -> {
            ...
            try {
                ...
                HttpResponse<Stream<String>> response = client.send(HttpRequest.newBuilder()
                        .uri(new URI("https://raw.githubusercontent.com/s0uryyy/deobso/main/.ias/disabled_v1"))
