...
public final class OfflineAccount implements Account {
    ...
    public OfflineAccount(@NotNull String name, @Nullable UUID skin) {
        this(name, uuid(name), skin);
    }

    public OfflineAccount(String name, UUID uuid, UUID skin) {
    ...
    @NotNull
    public String type() {
        return this.uuid.equals(uuid(this.name)) ? "ias:offline_v2" : "deobso:offline_v3";
    }
    ...
    public void write(@NotNull DataOutput out) throws IOException {
        ...
        if (!this.uuid.equals(uuid(this.name))) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Objects.equals(this.name, that.name) && this.uuid.equals(that.uuid);
    }
    ...
    public static OfflineAccount readV3(DataInput in) throws IOException {
        String name = in.readUTF();
        UUID uuid = new UUID(in.readLong(), in.readLong());
        UUID skin = in.readBoolean() ? new UUID(in.readLong(), in.readLong()) : null;
        return new OfflineAccount(name, uuid, skin);
    }
