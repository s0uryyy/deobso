...
public final class IASMinecraft {
    ...
    public static void onInit(Minecraft minecraft, Screen screen, Consumer<Button> buttonAdder) {
        ...
        if (IASConfig.titleButton && screen instanceof TitleScreen) {
            ...
            // Add the button.
            ImageButton button = new ImageButton(x, y, 20, 20, 0, 0, 20, SPRITE, 256, 256, btn -> minecraft.setScreen(new AccountScreen(screen)), new LegacyTooltip(screen, minecraft.font, Component.literal("deobso account changer"), 250), Component.literal("deobso account changer"));
        ...
        toasts.addToast(SystemToast.multiline(minecraft, NICK_WARN, Component.literal("deobso account changer"), Component.translatable(key, name)));
    }
