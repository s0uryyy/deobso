...
public final class AccountScreen extends Screen implements LastPassRenderCallback {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new Button(this.width / 2 - 154, this.height - 72, 308, 20,
                new net.minecraft.network.chat.TextComponent("Add accounts from folder"), btn -> FolderImportScreen.open(this)));

        // Add account list.
        if (this.list != null) {
            this.list.updateSize(this.width, this.height - 24 - 24 - 24 - 4 - 34, 34, this.height - 24 - 24 - 24 - 4);
        } else {
            this.list = new AccountList(this, this.minecraft, this.width, this.height - 24 - 24 - 24 - 4 - 34, 34, this.height - 24 - 24 - 24 - 4, 12);
        }
