...
final class AddPopupScreen extends Screen implements LastPassRenderCallback {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new PopupButton(this.width / 2 - 75, this.height / 2 + 24, 150, 20,
                new net.minecraft.network.chat.TextComponent("Ely.by"), btn -> {
            this.minecraft.setScreen(new ElyPopupScreen(this.parent, this.handler));
    ...
    public void renderBackground(PoseStack pose) {
        ...
        fill(pose, centerX - 80, centerY - 50, centerX + 80, centerY + 76, 0xF8_20_20_30);
        fill(pose, centerX - 79, centerY - 51, centerX + 79, centerY - 50, 0xF8_20_20_30);
        fill(pose, centerX - 79, centerY + 76, centerX + 79, centerY + 77, 0xF8_20_20_30);
    }
