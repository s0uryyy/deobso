...
public final class OfflinePopupScreen extends Screen {
    ...
    protected void init() {
        ...
        this.customUuid = new PopupBox(this.font, this.width / 2 - 75, this.height / 2 + 19, 148, 20,
                this.customUuid, Component.literal("UUID (Ctrl: force)"), this::done, false);
        this.customUuid.setMaxLength(128);
        this.customUuid.setHint(Component.literal("UUID (empty = automatic; Ctrl = force)"));
    ...
    private void type(boolean instant) {
        ...
        if (this.customUuid != null && !ru.vidtu.ias.account.CustomUuid.valid(this.customUuid.getValue()) && !controlDown()) {
            this.done.setTooltip(Tooltip.create(Component.literal("Invalid UUID. Hold Ctrl to convert to: " + ru.vidtu.ias.account.CustomUuid.resolve(this.name.getValue(), this.customUuid.getValue(), true))));
            this.done.active = false;
    ...
    public void renderBackground(GuiGraphics graphics) {
        ...
        graphics.fill(centerX - 80, centerY - 50, centerX + 80, centerY + 68, 0xF8_20_20_30);
        graphics.fill(centerX - 79, centerY - 51, centerX + 79, centerY - 50, 0xF8_20_20_30);
        graphics.fill(centerX - 79, centerY + 68, centerX + 79, centerY + 69, 0xF8_20_20_30);
    }
