...
final class ElyPopupScreen extends Screen {
    ...
    @Override protected void init() {
        ...
        this.addRenderableWidget(new PopupButton(this.width / 2 - 75, this.height / 2 + 52, 150, 20,
                net.minecraft.network.chat.CommonComponents.GUI_BACK, b -> onClose(), java.util.function.Supplier::get));
    }
    ...
    private void openBrowser() {
        ...
        try { ru.vidtu.ias.platform.IStonecutter.openUrl(device.browserUri().toString()); }
    ...
    /*public void render(GuiGraphics graphics, int mouseX, int mouseY, float delta) {*/
        ...
        ru.vidtu.ias.platform.IStonecutter.renderMultilineLabelCentered(label, graphics, this.width / 2, (this.height - label.getLineCount() * 9) / 2 - 14);
    }
