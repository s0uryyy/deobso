...
final class AddPopupScreen extends Screen {
    ...
    protected void init() {
        ...
        button.active = !ru.vidtu.ias.auth.ely.ElyAuth.injectorAvailable();
        ...
        this.addRenderableWidget(new PopupButton(this.width / 2 - 75, this.height / 2 + 24, 150, 20,
                Component.literal("Ely.by"), btn -> {
            //$ set_screen 'this.minecraft' 'new ElyPopupScreen(this.parent, this.handler)'
            this.minecraft.gui.setScreen(new ElyPopupScreen(this.parent, this.handler));
        }, java.util.function.Supplier::get));

        // Add cancel button.
        this.addRenderableWidget(new PopupButton(this.width / 2 - 75, this.height / 2 + 51, 150, 20,
    ...
    /*public void renderBackground(GuiGraphics graphics, int mouseX, int mouseY, float delta) {*/
        ...
        graphics.fill(centerX - 80, centerY - 50, centerX + 80, centerY + 76, 0xF8_20_20_30);
        graphics.fill(centerX - 79, centerY - 51, centerX + 79, centerY - 50, 0xF8_20_20_30);
        graphics.fill(centerX - 79, centerY + 76, centerX + 79, centerY + 77, 0xF8_20_20_30);
    }
