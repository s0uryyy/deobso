...
public final class IASMinecraft {
    ...
    public static void onInit(Minecraft minecraft, Screen screen, Consumer<Button> buttonAdder) {
        ...
        if (IASConfig.titleButton && screen instanceof TitleScreen) {
            ...
            }, Component.literal("deobso account changer"));
        ...
        /*if (IASConfig.serversButton && screen instanceof JoinMultiplayerScreen) {
            ...
            // Add the button.
            ImageButton button = new ImageButton(x, y, 20, 20, BUTTON, btn -> minecraft.setScreen(new AccountScreen(screen)), Component.literal("deobso account changer"));
            button.setTooltip(Tooltip.create(button.getMessage()));
            button.setTooltipDelay(Duration.ofMillis(250L));
            buttonAdder.accept(button);
        }
        ...
        *///?}
        ...
        // Display the toast.
        //? if >=26.2 {
        final SystemToast toast = new SystemToast(NICK_WARN, Component.literal("deobso account changer"), Component.translatable(key, name));
        //?} else {
        /*final SystemToast toast = SystemToast.multiline(minecraft, NICK_WARN, Component.literal("deobso account changer"), Component.translatable(key, name));
        *///?}
